...
- **Frontend:** https://fitness-tracker-frontend-kjf4.onrender.com
- **Backend API:** https://fitness-tracker-backend-f306.onrender.com
...
- **Admin Panel** — Create, edit, and delete challenges;  (admin role only)
